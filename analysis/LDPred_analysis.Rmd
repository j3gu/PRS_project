...
## Softwares for computing polygenic risk scores 
### Goal: 
The goal is to compare different softwares that are used to build PRSs for their accuracy in predicting the disease risks. 
  Data Availability: 
