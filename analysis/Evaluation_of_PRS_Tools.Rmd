...
![The Barplot of the model fit R-squared at different p-value thresholds.](docs/assets/PRSice_bar_plot.png)
```{r}
knitr::include_graphics("assets/PRSice_bar_plot.png")
```


![P-values for the model fit against different p-value thresholds](docs/assets/PRSice_scatter_plot.png)
#### Lassosum
...
![Comparison of prediction performance between two softwares: x-axis shows the polygenic risk scores and y-axis represents the true phenotypes.](docs/assets/scatter_plots_true_pheno_vs_pgs.png)
