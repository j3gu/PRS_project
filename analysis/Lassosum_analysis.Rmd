...
hist(as.numeric(final_expr[final_expr[, 2] == "AC080125.1", -1:-2]), main = "After Normalization", xlab = "Expression levels for GAPDH")
...
hist(as.numeric(final_expr[final_expr[, 2] == "AC080125.1", -1:-2]), main = "Inverse normal transformation", xlab = "gene expression")
...
![Log2 transformation for gene GAPDH](../output/GAPDH_expr_log2_hist.png)
![Log2 transformation for gene GATA3](../output/GATA3_expr_log2_hist.png)
![Log2 transformation for gene ](../output/AC080125.1_expr_log2_hist.png)
